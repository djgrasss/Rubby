Feature: we might want a hash or something
  ...
  Scenario: I create a hash with curly braces on Ruby 1.9
    Given I am targetting Ruby 1.9
    When I enter '{ foo: 1, bar: 2 }'
    And I transpile it
    Then I should get '{ foo: 1, bar: 2 }'

  Scenario: I create a hash with curly braces on Ruby 1.8
    Given I am targetting Ruby 1.8
    When I enter '{ foo: 1, bar: 2 }'
    And I transpile it
    Then I should get '{ :foo => 1, :bar => 2 }'
