...
Gem::Specification.new do |gem|
  ...
  %w[bundler rspec rspec-mocks guard guard-rspec guard-bundler guard-cucumber guard terminal-notifier-guard cucumber rb-fsevent rake coveralls kpeg guard-rake].each do |dep|
